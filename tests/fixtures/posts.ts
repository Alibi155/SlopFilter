...
That is why we built Northwind, an AI go-to-market engine trained on data earned by helping companies reach the right people.

We are raising now. Learn more and earn bonus shares here: https://lnkd.in/example1`,
  ),

  // Modelled on a real feed post that scored too low: the survey-listicle hook
  // and the fundraise pivot fired, but the opener, the CTA, the scale flex and
  // the closing poll did not. Brand names and links here are invented — the
  // fixtures reproduce the pattern, never anyone's actual post.
  slopAi(
...
A survey of over 1,000 people, run by a magazine publisher, looked at how people talk to AI.
...
Funny enough, Northwind started the same way: one community, growing into something bigger.

14M+ people first.
Then some large enterprises came on board.
Add a course platform with 100K+ students, and you get Northwind.

We're raising through the end of August.

Early backers get bonus shares up to 22%.

Come see what we're building: https://lnkd.in/example2
